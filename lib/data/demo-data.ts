...
export const demoPosts: Post[] = [
  ...
  },
  {
    ...
    promptId: undefined,
    content:
      "First time here. Not sure what to expect but I'm ready to try something different. My therapist recommended this community.",
    isPromptResponse: false,
  ...
  },
  {
    ...
    promptId: undefined,
    content:
      "The community agreements resonated with me. Especially the part about no fixing or diagnosing. I appreciate that.",
    isPromptResponse: false,
    createdAt: new Date(Date.now() - 43200000),
  ...
  },
  {
    ...
    promptId: undefined,
    content:
      "Started a grounding practice this week. Paying attention to sensations instead of thoughts is harder than I expected but feels rewarding.",
    isPromptResponse: false,
    createdAt: new Date(Date.now() - 57600000),
  ...
  },
  {
    ...
    promptId: undefined,
    content:
      "When I slow down and really feel my body, I notice where I'm holding stress. It's becoming clearer that my body is always communicating something.",
    isPromptResponse: false,
    createdAt: new Date(Date.now() - 43200000),
  ...
  {
    id: "couples-002",
    userId: "user-robert-lisa",
    authorName: "Robert & Lisa",
    authorPhoto: generateAvatarUrl("RL"),
    spaceId: "couples",
    promptId: undefined,
    content:
      "After 15 years together, we're rediscovering what it means to actually be present with each other. Not just coexisting.",
    isPromptResponse: false,
  ...
  },
  {
    ...
    promptId: undefined,
    content:
      "Communication has been the biggest unlock for us. Turns out we weren't actually stuck – we just needed better tools to talk.",
    isPromptResponse: false,
