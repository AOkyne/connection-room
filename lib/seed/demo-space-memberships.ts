...
export const demoSpaceMemberships: Record<string, string[]> = {
  ...
  "demo-alex-m": ["commons", "start-here", "dating-desire", "spirituality-sexuality"],
  ...
  "demo-david-l": ["commons", "start-here", "masculinity-sexuality", "spirituality-sexuality"],
  ...
  "demo-ethan-b": ["commons", "start-here", "spirituality-sexuality", "touch-and-affection"],
  ...
  "demo-isaac-b": ["commons", "start-here", "spirituality-sexuality", "dating-desire"],
  "demo-michael-p": ["commons", "start-here", "couples-closeness", "touch-and-affection"],
  "demo-william-r": ["commons", "start-here", "dating-desire", "spirituality-sexuality"],
