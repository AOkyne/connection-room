...
export function renderPollHtml(question: string, options: PollEmailOption[]): string {
  ...
  <tr>
    <td style="padding:20px;background-color:#f3ede5;border-radius:12px;">
      <p style="margin:0 0 14px 0;font-family:Georgia,serif;font-size:18px;line-height:1.5;color:#1a0f0a;">${questionText}</p>
