        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            {postTemplates.map((template) => (
              ...
              >
                <p className="font-medium text-[#1a0f0a]">{template.title}</p>
                <p className="text-xs text-[#c97a2a] mt-1">{template.subtitle}</p>
                {template.exampleTone && (
                  <p className="text-xs text-[#a0704a] mt-2 italic">
            ...
            <div className="bg-[#f8f6f2] rounded-lg p-4 space-y-2">
              ...
              {postTemplates
                ...
                ?.starterPrompts.map((prompt, idx) => (
                  <p key={idx} className="text-sm text-[#1a0f0a]">
                    • {prompt}
                  </p>
                ))}
            </div>
